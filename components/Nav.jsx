...
const Nav = () => {
  ...
  return (
      <nav className=' flex justify-between items-center'>
        ...
        <p className='hover:border-b-2 hover:border-b-[#214E34] border-2 border-white rounded-none'><AiOutlineUser style={{fontSize:'24px'}}/></p>
        <p className='hover:border-b-2 hover:border-b-[#214E34] border-2 border-white rounded-none'><AiOutlineShoppingCart style={{ fontSize: '24px' }} /></p>
        <p className='hover:border-b-2 hover:border-b-[#214E34] border-2 border-white rounded-none'><AiOutlineHeart style={{fontSize:'24px'}}/></p>
          </div>
          ...
          <motion.div
            ...
            <div className='flex flex-col justify-between items-start'>
              <div className='py-12  flex justify-between flex-col h-[40vh] text-[#214E34] w-full'>
                ...
                <p className='py-2 px-5 text-lg flex gap-2 items-center hover:bg-[#214E34] hover:text-white rounded-md'><AiOutlineShoppingCart style={{ color: "white" }} /> Cart</p>
                <p className='py-2 px-5 text-lg flex gap-2 items-center hover:bg-[#214E34] hover:text-white rounded-md'><AiOutlineHeart style={{ color: "white" }} /> Liked</p>
              </div>
